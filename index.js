...
export default AliyunOSS = {
  ...
  initWithPlainTextAccessKey(
    ...
    RNAliyunOSS.initWithPlainTextAccessKey(
      accessKey,
      secretKey,
      endPoint,
      configuration,
  ...
  initWithImplementedSigner(
    ...
    RNAliyunOSS.initWithImplementedSigner(
      signature,
      accessKey,
      endPoint,
      configuration,
  ...
  initWithSecurityToken(
    ...
    RNAliyunOSS.initWithSecurityToken(
      securityToken,
      accessKey,
      secretKey,
      endPoint,
  ...
  asyncResumableUpload(bucketName, objectKey, filepath = '', options = {}) {
    return RNAliyunOSS.asyncResumableUpload(
      bucketName,
      objectKey,
      filepath,
      options,
  ...
  asyncAppendObject(bucketName, objectKey, filepath, options = appendOptions) {
    return RNAliyunOSS.asyncAppendObject(
      bucketName,
      objectKey,
      filepath,
      options,
  ...
  multipartUpload(
    ...
    return RNAliyunOSS.multipartUpload(
      bucketName,
      objectKey,
      uploadId,
      filepath,
  ...
  asyncCopyObject(
    ...
    return RNAliyunOSS.asyncCopyObject(
      srcBucketName,
      srcObjectKey,
      desBucketName,
      destObjectKey,
  ...
  addEventListener(event, callback) {
    const RNAliyunEmitter =
      Platform.OS === 'ios'
        ? new NativeEventEmitter(RNAliyunOSS)
        : DeviceEventEmitter;
    switch (event) {
      case 'uploadProgress':
